...
function StackFx(el) {
  ...
  this.DOM.img =
    this.DOM.stack.querySelector(".stack__figure > .stack__img") || "";
  this.DOM.caption = this.DOM.el.querySelector(".grid__item-caption") || "";
  this.DOM.title = this.DOM.caption && this.DOM.caption.querySelector(".grid__item-title") || "";
  this.DOM.columns = {
    left: this.DOM.caption && this.DOM.caption.querySelector(".column--left") || "",
    right: this.DOM.caption && this.DOM.caption.querySelector(".column--right") || "",
  };
}
